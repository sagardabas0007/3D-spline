                ...
                >
                  ...
                  <div className="lg:flex hidden items-center space-x-4">
                      <motion.a
                          ...
                          href="" className="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 duration-300">
                  ...
                  className="lg:hidden bg-white dark:bg-gray-900 shadow-l px-4 py-5 space-y-5">
                      <nav className="flex flex-col space-y-3  ">
                          {["Home", "About", "Services", "Projects", "Contact"].map((item) => (
                              <a onClick={toggleMenu} className="text-gray-300 font-medium py-2" href="" key={item}>{item}</a>
                          ))}
                  </nav>
                  ...
                  >
                      ...
                      <motion.div
                          ...
                          <div className="flex items-center justify-between">
                              ...
                              <motion.button whileHover={{scale:1.1}} whileTap={{scale:0.8}} onClick={closeContactForm}><FiX className="h-7 w-7"/></motion.button>
                          </div>
                      ...
                      <form className="space-y-4">
                          <div>
                              ...
                              <input type="text" id="name" placeholder="Your name" className="w-full border border-gray-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-700 outline-none"/>
                          </div>
                          <div>
                              <label htmlFor="email" className="block text-sm font-medium text-gray-300 mb-1 ">Email</label>
                              <input type="text" id="name" placeholder="Your email" className="w-full border border-gray-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-700 outline-none"/>
                          </div>
                          <div>
                              <label htmlFor="message" className="block text-sm font-medium text-gray-300 mb-1 ">Message</label>
                              <textarea rows="4" id="name" placeholder="Leave a message" className="w-full h-32 border border-gray-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-700 outline-none"/>
                              </div>
                              
                              <motion.button
                                  whileHover={{ scale: 1.03 }}
                                  whileTap={{scale:0.97}}
                                  className="w-full px-4 py-2 bg-gradient-to-r from-violet-600 to-violet-400 hover:from-violet-700 hover:to-purple-700 transition-all duration-800 rounded-lg shadow-md hover:shadow-violet-600/50">send message</motion.button>
                      </form>
                      </motion.div>
                  </div>
                  )}
